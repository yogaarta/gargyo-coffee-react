    ...
    return (
      <main>
        ...
        <div className="new-global-container">
          <div className='new-title'>Products <span>{'>'} Add New Product</span></div>
          <section className='new-main-container'>
            ...
            <div className='new-right-container'>
              ...
              <input type="text" name='name' id='name' className='new-text-input' placeholder='Type product name' />
              <label htmlFor="price" className='new-label'>Price :</label>
              <input type="text" name='price' id='price' className='new-text-input' placeholder='Type the price' />
              <label htmlFor="description" className='new-label'>Description :</label>
              <input type="text" name='description' id='description' className='new-text-input' placeholder='Describe the product' />
